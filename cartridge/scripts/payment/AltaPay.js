...
function Handle(args) {
	...
	var ret = txn.wrap (
			function () {
				var cp = require('~/cartridge/scripts/pipelet/CreatePaymentInstrument.ds');
...
function Authorize(args) {
	...
	var ret = txn.wrap (
			function () {
				var cp = require('~/cartridge/scripts/pipelet/CheckPreRequisites.ds');
	...
	// CREATE PAYMENT: ==================================================================
	var pc = require('~/cartridge/scripts/pipelet/PaymentCreate.ds');
	ret = pc.create(args);
