...
function payment(orderConfirmed) { 
	...
	var ST = require('int_altapay/cartridge/scripts/pipelet/SaveCreditCardToken.ds');
	ST.save();
	...
	// Validate Referrer ===============================================================
	var VAL = require('int_altapay/cartridge/scripts/pipelet/ValidateAltaPayAsReferrer.ds');
	...
	ret = txn.wrap (
			function () {
				var UPD = require('int_altapay/cartridge/scripts/pipelet/AltaPayUpdateOrderPaymentInstrument.ds');
	...
	var ONM = require('int_altapay/cartridge/scripts/pipelet/UpdateOpenNotificationMessage.ds');
...
function gotoCOBillingStart(fraudError) { // Redirects to the billing page
	...
	// UpdateErrorMessage ==================================================================
	var UPD = require('int_altapay/cartridge/scripts/pipelet/UpdateErrorMessage.ds');
...
function notification() {
	...
	// FindOrder ==================================================================
	var FO = require('int_altapay/cartridge/scripts/pipelet/FindOrder.ds');
	...
	var result = txn.wrap (
			function () {
				var CON = require('int_altapay/cartridge/scripts/pipelet/ControlOpenNotification.ds');
